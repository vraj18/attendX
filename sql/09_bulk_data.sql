...
DECLARE
    ...
    depts name_array := name_array('Computer Science', 'Information Tech', 'Electronics', 'Mathematics', 'Mechanical', 'Civil', 'Electrical', 'Physics', 'Chemistry', 'Biology');
...
BEGIN
    ...
    FOR i IN 1..100 LOOP
        ...
        v_dept := depts(TRUNC(DBMS_RANDOM.VALUE(1, 4))); -- Mostly CS, IT, EC
        ...
        PKG_REGISTRATION.SP_ADMIT_STUDENT(
            v_name, v_email, '9' || TO_CHAR(TRUNC(DBMS_RANDOM.VALUE(100000000, 999999999))),
            ADD_MONTHS(SYSDATE, -240), v_level, v_dept, 'admin', v_sid, v_msg
        );
